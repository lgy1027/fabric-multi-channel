...
class UpdateVehicleStatusWorkload extends WorkloadModuleBase {
    constructor() {
        super();
    ...
    async submitTransaction() {
        ...
        let args = {
            ...
            contractFunction: 'UpdateVehicleStatus', // 调用的函数
 ...
 * 创建工作负载模块实例
 */
function updateWorkloadModule() {
    return new UpdateVehicleStatusWorkload();
}

module.exports.createWorkloadModule = updateWorkloadModule;
